...
function RaceCard(props){
    ...
    let yesterday = currentDate.getFullYear() + "-" + (currentDate.getMonth() + 1) + "-" + (currentDate.getDate() - 1)
    ...
    if ((currentDate.getMonth() + 1) < 10 && (currentDate.getDate() - 1) < 10){
        yesterday = currentDate.getFullYear() + "-" + 0 + (currentDate.getMonth() + 1) + "-" + 0 + (currentDate.getDate() - 1)
    } else if ((currentDate.getMonth() + 1) < 10){
        yesterday = currentDate.getFullYear() + "-" + 0 + (currentDate.getMonth() + 1) + "-" + (currentDate.getDate() - 1)
    } else if (currentDate.getDate() < 10){
        yesterday = currentDate.getFullYear() + "-" + (currentDate.getMonth() + 1) + "-" + 0 + (currentDate.getDate() - 1)
    }
